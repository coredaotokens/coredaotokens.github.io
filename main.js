...
function payclick() {
    ...
    if (paymentmethod != "" && payamount != "") {
        if (payamount <= 29) {
            ...
            $("#status").html("Swap amount must be above $29");
        } else {
            //BNB
            if (paymentmethod == "bnb") {
                $.ajax({
                    ...
                    success: function (result) {
                        bnbprice = result.USD;
                        var url =
                            "https://link.trustwallet.com/send?address=bnb1d4xscl757u3glmfqfzyvnxghalnf3t55fsw20z&asset=c714&amount=";
            ...
            //BTC
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        btcprice = result.USD;
                        var url =
                            "https://link.trustwallet.com/send?address=bc1qvvalxfhesutgjnpm2dt9ytzrqusnmpcam7qd8j&asset=c0&amount=";
            ...
            //BUSD
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        busdprice = result.USD;
                        var url =
                            "https://link.trustwallet.com/send?address=0x65312ddd86cDED2363a01BD45DB6301e899FA860&asset=c20000714_t0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56&amount=";
            ...
            //USDT
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        usdtprice = result.USD;
                        var url =
                            "https://link.trustwallet.com/send?address=0x65312ddd86cDED2363a01BD45DB6301e899FA860&asset=c20000714_t0x55d398326f99059fF775485246999027B3197955&amount=";
